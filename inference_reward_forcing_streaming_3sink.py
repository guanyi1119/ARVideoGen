# Reward-Forcing Streaming Inference entry point — 3-Sink variant
# Based on inference_reward_forcing_streaming.py, adapted for 3-sink KV-cache layout.
# Uses StreamingCausalInferencePipeline3Sink / SwitchCausalInferencePipeline3Sink
# and the reward_forcing_3sink wan wrapper classes.
import argparse
import torch
import os
...
from methods.reward_forcing.pipelines.streaming_causal_inference_3sink import (
    StreamingCausalInferencePipeline3Sink as CausalInferencePipeline,
)
