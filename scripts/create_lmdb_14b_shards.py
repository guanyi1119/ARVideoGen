"""
Aggregate all ODE pairs inside a folder into sharded LMDB datasets.
Designed for processing large 14B parameter model datasets.

Usage:
    python create_lmdb_14b_shards.py \
    --data_path <path_to_ode_pairs> \
    --lmdb_path <path_to_lmdb> \
    --num_shards 16

# Self-Forcing: process 14B data shards
"""
...
from core.data.lmdb_utils import store_arrays_to_lmdb, process_data_dict
