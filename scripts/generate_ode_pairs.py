"""
Generate ODE trajectory pairs from videos using the Wan diffusion model.
Each trajectory is saved as a .pt file containing prompt -> latent pairs.

Usage:
    torchrun --nproc_per_node=N generate_ode_pairs.py \
        --output_folder <path> \
        --caption_path <path> \
        --guidance_scale 6.0

# Self-Forcing: generate ODE pairs for distillation training
"""
