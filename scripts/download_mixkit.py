"""
Download and extract the MixKit dataset from Hugging Face Hub.

Usage:
    python download_mixkit.py \
        --local_dir /mnt/localssd/ \
        --repo_id Languagebind/Open-Sora-Plan-v1.1.0 \
        --folder_name all_mixkit

# CausVid: download MixKit dataset for distillation data preparation
"""
import argparse
import os
import tarfile
