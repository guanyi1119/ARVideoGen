"""
Compute VAE latent representations from video data.

Usage:
    torchrun --nproc_per_node=N compute_vae_latent.py \
        --input_video_folder <path> \
        --output_latent_folder <path> \
        --info_path <path>

# CausVid: compute VAE latents for distillation data preparation
"""
