...
Taken from FastVideo https://github.com/hao-ai-lab/FastVideo/tree/main
Apache-2.0 License

Usage:
    python process_mixkit.py \
        --input_dir <path> \
        --output_dir <path> \
        --width 1280 \
        --height 720 \
...
# CausVid: process MixKit videos for distillation data preparation
"""
import argparse
import logging
import time
