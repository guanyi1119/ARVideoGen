    ...
    def inference_with_rolling_forcing(
        ...
        for window_index in range(window_num):
            ...
            if current_num_frames == rolling_window_length_blocks * self.num_frame_per_block:
                ...
                raise ValueError("current_num_frames should be equal to rolling_window_length_blocks * num_frame_per_block, or the first or last window.")
