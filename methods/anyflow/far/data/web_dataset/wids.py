...
# NOTE: change to ordered mapping to more flexbile dict
# TODO:  submit a PR to fix the mapping issue.
...
def default_decoder(sample: Dict[str, Any], format: Optional[Union[bool, str]] = True):
    ...
    for key, stream in sample.items():
        ...
        if key.startswith('__'):
            ...
            sample[key] = torch.load(stream, weights_only=True, map_location='cpu')
...
class IndexedTarSamples:
    ...
    def __init__(
        ...
        *,
        ...
        # NOTE: https://stackoverflow.com/questions/11072705/twitter-trends-api-unicodedecodeerror-utf8-codec-cant-decode-byte-0x8b-in-po
        # import gzip
