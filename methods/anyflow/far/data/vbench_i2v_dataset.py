...
class VBenchI2VDataset(Dataset, ConfigMixin):

    config_name = 'vbench_i2v_dataset_config.json'
    ...
    def __getitem__(self, index: int) -> dict[str, Any]:
        ...
        sample['image_name'] = os.path.join(self.config.image_dir, sample['image_name'])
        return sample
