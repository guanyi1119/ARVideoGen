...
from core.wan_wrapper.wan_wrapper_rollingforcing import WanDiffusionWrapper, WanTextEncoder, WanVAEWrapper
from methods.rolling_forcing.pipelines.rolling_forcing_training import RollingForcingTrainingPipeline
...
class RollingForcingModel(BaseModel):
    ...
    def _run_generator(
        ...
        dist.broadcast(torch.tensor(num_generated_frames, device=self.device), src=0)
