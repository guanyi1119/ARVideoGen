from core.wan_wrapper import InferencePipelineInterface
from methods.causvid.wan_factory import (
    get_diffusion_wrapper, get_text_encoder_wrapper, get_vae_wrapper,
    get_inference_pipeline_wrapper
)
from methods.causvid.loss import get_denoising_loss
...
class DMD(nn.Module):
    ...
    def critic_loss(self, image_or_video_shape, conditional_dict: dict, unconditional_dict: dict, clean_latent: torch.Tensor) -> Tuple[torch.Tensor, dict]:
        ...
        if self.args.denoising_loss_type == "flow":
            ...
            from core.wan_wrapper.wan_wrapper_causvid import WanDiffusionWrapper
