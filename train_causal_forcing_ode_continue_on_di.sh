...
python -c "import moxing as mox; mox.file.copy_parallel('obs://yw-pixelgeek-training-data-gy1/01.USERS/z00546255/data/custom_ct_2m_shrink/test_lmdb_ode', '/cache/lmdb_ode')"
