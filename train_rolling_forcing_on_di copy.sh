...
torchrun --nproc_per_node=8 --rdzv_conf="timeout=7200" --nnodes=$VC_WORKER_NUM --node_rank=$VC_TASK_INDEX --master_addr $MASTER_ADDR --master_port 12345 train_rolling_forcing.py \
    --config_path configs/rolling_forcing/rolling_forcing_dmd.yaml \
    --logdir train_outputs/rolling_forcing_dmd_5steps
