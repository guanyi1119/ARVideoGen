# Reward-Forcing 3-Sink variant of wan_wrapper
# Cloned from core/wan_wrapper/wan_wrapper_reward_forcing.py with changes:
#   - Imports CausalWanModel3Sink from wan.modules.causal_model_reward_forcing_3sink
#   - WanDiffusionWrapper.__init__ accepts long_sink_size, mid_sink_size,
#     long_compression_alpha, mid_compression_alpha instead of sink_size
#   - Passes these new params to CausalWanModel.from_pretrained(...)
# All other logic is identical to the Reward-Forcing wrapper.
import os
import types
...
from wan.modules.causal_model_reward_forcing_3sink import CausalWanModel3Sink as CausalWanModel
    ...
    def __init__(
        ...
        if is_causal:
            self.model = CausalWanModel.from_pretrained(
                ...
                long_sink_size=long_sink_size,
                mid_sink_size=mid_sink_size,
                long_compression_alpha=long_compression_alpha,
                mid_compression_alpha=mid_compression_alpha,
            )
        else:
