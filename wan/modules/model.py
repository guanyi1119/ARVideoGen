...
# [DIFF-CausVid] CausVid does NOT have WanGanCrossAttention, GanAttentionBlock, or RegisterTokens classes
...
# [DIFF-CausVid] CausVid does NOT have GanAttentionBlock (GAN classification mode not supported)
...
# [DIFF-CausVid] CausVid does NOT have RegisterTokens class
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(self,
        ...
        self.cross_attn_norm = cross_attn_norm
        self.eps = eps
        self.local_attn_size = 21  # [DIFF-CausVid] CausVid does NOT have local_attn_size
    ...
    # [DIFF-CausVid] CausVid's forward() directly calls _forward without the *args/**kwargs wrapper
    def forward(
        self,
        *args,
        **kwargs
    ...
    # [DIFF-CausVid] CausVid's _forward does NOT have: classify_mode, concat_time_embeddings,
    # register_tokens, cls_pred_branch, gan_ca_blocks params; no import of `amp`; no `from einops import repeat`
    def _forward(
        self,
        x,
        t,
        ...
        clip_fea=None,
        y=None,
        sink_recache_after_switch=False,  # [DIFF-LongLive] LongLive adds this param for deferred cache update
    ):
        r"""
        ...
        # [DIFF-CausVid] CausVid does NOT have the classify_mode block, gan_idx, or related GAN logic below
        final_x = None
        if classify_mode:
    ...
    # [DIFF-CausVid] CausVid does NOT have _forward_classify method at all
    ...
    # [DIFF-CausVid] CausVid's unpatchify does NOT have the `c` parameter (always uses self.out_dim)
