...
try:
    ...
    def is_hopper_gpu():
        if not torch.cuda.is_available():
            return False
        # [DIFF-CausVid] CausVid hardcodes FLASH_ATTN_3_AVAILABLE = True (no GPU detection)
        # [DIFF-LongLive] LongLive uses CUDA capability >=9 instead of device name:
        #   major, _ = torch.cuda.get_device_capability(); return major >= 9
...
def flash_attention(
    ...
    if (version is None or version == 3) and FLASH_ATTN_3_AVAILABLE:
        ...
        x = flash_attn_interface.flash_attn_varlen_func(
            ...
            causal=causal,
            # [DIFF-LongLive] LongLive uses .unflatten(0, (b, lq)) without [0] indexing
