# Causal-Forcing / Self-Forcing version of causal_model
# Key features vs other variants:
#   - Has _prepare_teacher_forcing_mask, local_attn_size/sink_size, I2V mask, clean_x/aug_t, cache_start
#   - [DIFF-CausVid] CausVid uses window_size instead of local_attn_size/sink_size, simplified KV cache, current_end instead of cache_start, no TF/I2V support
#   - [DIFF-LongLive] LongLive adds deferred cache update (cache_update_info + _apply_cache_updates), sink_recache_after_switch, supports list/tuple local_attn_size, sink token separated attention
