...
# LongLive Infinity version of causal_model
# Key features: Infinite length attention mechanism
#   - [DIFF-Base] Completely different attention mechanism for unlimited sequence length
#   - [DIFF-LongLive] Adds infinite length support beyond LongLive's deferred cache update
